...
class AMSEmailScheduleEventHandler(AbstractAMSScheduleEventHandler,AbstractStateEventHandler):
    ...
    def __init__(self, logger, config, schedule_name=None):
        ...
        if schedule_name is None:
            ...
            try:
                self.AMSSchedule = self.ams_config.get_schedule_by_name(schedule_name)
