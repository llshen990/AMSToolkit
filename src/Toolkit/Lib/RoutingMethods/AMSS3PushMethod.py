...
class AMSS3PushMethod(AbstractAMSMethod):
    ...
    def _route_tmp(self, source_file, to_path_tmp):
        try:
            ...
            self.ams_s3.put(os.path.join(self.config.from_directory, source_file), to_path_tmp)
            return True
    ...
    def _route_final(self, source_file, final_target, to_path_tmp):
        try:
            ...
            self.ams_s3.rename(to_path_tmp, final_target)
        except AMSFatalException:
            raise
    ...
    def _check_and_create_target_tmp_dir(self):
        try:
            ...
            return self.ams_s3.create_dir(self._to_tmp_folder)
        except Exception as e:
            raise AMSMethodException(e)
    ...
    def _check_and_create_target_to_dir(self):
        try:
            ...
            return self.ams_s3.create_dir(self.config.to_directory)
        except Exception as e:
            raise AMSMethodException(e)
    ...
    def _create_remote_dir(self, directory):
        try:
            ...
            self.ams_s3.create_dir(directory)
        except Exception as e:
